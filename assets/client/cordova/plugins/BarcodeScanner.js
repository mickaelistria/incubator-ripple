 ...
 * CORDOVASIM
 *
 * BarcodeScanner plugin (https://github.com/phonegap-build/BarcodeScanner/) implementation
 * Using google QR service - https://developers.google.com/chart/infographics/docs/qr_codes
 *
 */
...
module.exports = {
    ...
    encode: function(success, error, args) {
        ...
        barcodeImage.attr("style", "position: relative;" + "z-index: 2147483647;" // max value of z-index
            + "width: 100%;");
        barcodeImage.appendTo(barcodeWrapper);

        barcodeData.attr("style", "position: relative;" + "text-align: center;" + "font-family: Tahoma, Geneva, sans-serif;" + "font-size: 25px;" + "color: black;" + "bottom: 30px;" + "padding: 10px;" + "z-index: 2147483647;" + "background-color: white;");
        barcodeData.appendTo(barcodeWrapper);

        barcodeWrapper.attr("style", "position: absolute;" + "top: 0;" + "right: 0;" + "bottom: 0;" + "left: 0;" + "width: 100%;" + "height: 100%;" + "min-height: 100%;" + "z-index: 2147483647;" + "background-color: white;");
        ...
        backgroundMask.attr("style", "position: fixed;" // div covers 100% of page (not screen) - need it for devices with a really small screens
            + "left: 0px;" + "top: 0px;" + "width: 100%;" + "height: 100%;" + "z-index: 2147483646;" + "background-color: white;");
