...
function checkForRepeatReload() {
    ...
    var time = new Date().getTime(),
        lastLoad = JSON.parse(window.customLocalStorage['ripple-last-load'] || null) || {time: time, counter: 0};
    ...
    window.customLocalStorage['ripple-last-load'] = JSON.stringify(lastLoad);
}
