...
function _updateInformationView() {
    ...
    if (widgetInfo.name) {
        infoList.push('<section class="information-widgetname"><label class=\"ui-text-label\">App Name: </label><span class="text-is-selectable">' + widgetInfo.name + '</span></section>');
    }
    if (widgetInfo.version) {
        infoList.push('<section class="information-widgetversion"><label class=\"ui-text-label\">App Version: </label><span class="text-is-selectable">' + widgetInfo.version + '</span></section>');
    }
    // TODO - Need to reimplement it in context of JBIDE-14505
